    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text(
              "nguyenvana@email.com", style: TextStyle(color: Colors.grey)),
          const SizedBox(height: 20),
          ...
          Padding(
            ...
            child: ListTile(
              ...
              leading: const Icon(CupertinoIcons.cart, color: Colors.blue),
              // Màu icon
              title: const Text(
                "Lịch sử đơn hàng",
          ...
          Padding(
            ...
            child: ListTile(
              ...
              leading: const Icon(CupertinoIcons.lock, color: Colors.blue),
              // Màu icon
              title: const Text(
                "Đổi mật khẩu",
                style: TextStyle(fontSize: 16,
