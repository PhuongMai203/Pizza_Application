    ...
    return Padding(
      ...
      child: TypeAheadField<Prediction>(
        ...
        suggestionsCallback: (pattern) async {
          ...
          final response = await places.autocomplete(pattern, language: "vi", components: [Component(Component.country, "vn")]);
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => OrderDetailScreen(
            ...
            totalPrice: (firstPizza.price - (firstPizza.price * firstPizza.discount / 100)) * firstPizza.quantity,
